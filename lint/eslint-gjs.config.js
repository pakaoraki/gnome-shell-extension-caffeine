export default [
  ...
  rules: {
    ...
    'block-spacing': 'error',
    'brace-style': 'error',
    camelcase: ['error', { properties: 'never', allow: ['^vfunc_', '^on_', '_instance_init'] }],
    ...
    indent: ['error', 4, { ignoredNodes: [
      // Allow not indenting the body of GObject.registerClass
      // since in the future it's intended to be a decorator
    ...
    'no-unused-vars': ['error', { varsIgnorePattern: '^unused|_$', argsIgnorePattern: '^(unused|_)' }],
